...
%!      count_initial(+Spec,-Count) is det.
%
...
%       generate_initial/2 when given Spec.
%
count_initial(S,N):-
        generate_initial(S,Es)
        ,length(Es,N).


%!      count_initial(+Lang,+N,+Min,+Max,-Examples) is det.
%
