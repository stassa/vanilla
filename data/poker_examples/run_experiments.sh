...
##
#csv="${tp}binary_parity_range_${ts}.csv"
#log="${tp}binary_parity_range_${ts}.log"
#swipl -g "([load_headless], experiment_output:run_experiment_protocol(s/2,binary_parity_range($reps,'$csv',false),'$log'))." -t halt &
### Sleep two seconds to give logging the chance to create a new log file.
#sleep 2
#
...
#sleep 2
#
#csv="${tp}binary_anbn_uo_range_${ts}.csv"
#log="${tp}binary_anbn_uo_range_${ts}.log"
#swipl -g "([load_headless], experiment_output:run_experiment_protocol(s/2,binary_anbn_uo_range($reps,'$csv',false),'$log'))." -t halt &
#sleep 2
#
...
## L-System low uncertainty regime experiments
...
##
#csv="${tp}dragon_curve_range_${ts}.csv"
#log="${tp}dragon_curve_range_${ts}.log"
#swipl -g "([load_headless], experiment_output:run_experiment_protocol(s/3,dragon_curve_range($reps,'$csv',false),'$log'))." -t halt &
#sleep 2
#
#csv="${tp}hilbert_curve_range_${ts}.csv"
#log="${tp}hilbert_curve_range_${ts}.log"
#swipl -g "([load_headless], experiment_output:run_experiment_protocol(s/3,hilbert_curve_range($reps,'$csv',false),'$log'))." -t halt &
#sleep 2
#
#csv="${tp}koch_curve_range_${ts}.csv"
#log="${tp}koch_curve_range_${ts}.log"
#swipl -g "([load_headless], experiment_output:run_experiment_protocol(s/3,koch_curve_range($reps,'$csv',false),'$log'))." -t halt &
#sleep 2
#
#csv="${tp}sierpinski_triangle_range_${ts}.csv"
#log="${tp}sierpinski_triangle_range_${ts}.log"
#swipl -g "([load_headless], experiment_output:run_experiment_protocol(s/3,sierpinski_triangle_range($reps,'$csv',false),'$log'))." -t halt &
#sleep 2
